            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="#"><span class="badge rounded-pill text-bg-success float-end" key="t-new">@lang('translation.New')</span> <span key="t-jobs">@lang('translation.Jobs')</span></a></li>
                    </ul>
                </li>
                    ...
                    <ul class="sub-menu" aria-expanded="true">
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="true">
                                ...
                                <li><a href="#" key="t-boxed-width">@lang('translation.Boxed_Width')</a>
                                </li>
                                <li><a href="#" key="t-preloader">@lang('translation.Preloader')</a>
                                </li>
                                <li><a href="#"
                                        key="t-colored-sidebar">@lang('translation.Colored_Sidebar')</a></li>
                                <li><a href="#" key="t-scrollable">@lang('translation.Scrollable')</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="true">
                                <li><a href="#" key="t-horizontal">@lang('translation.Horizontal')</a>
                                </li>
                                <li><a href="#"
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="#" key="t-job-list">@lang('translation.Job_List')</a></li>
                        <li><a href="#" key="t-job-grid">@lang('translation.Job_Grid')</a></li>
                        <li><a href="#" key="t-apply-job">@lang('translation.Apply_Job')</a></li>
                        <li><a href="#" key="t-job-details">@lang('translation.Job_Details')</a></li>
                        <li><a href="#" key="t-Jobs-categories">@lang('translation.Jobs_Categories')</a></li>
                        <li>
                            <a href="javascript: void(0);" class="has-arrow" key="t-candidate">@lang('translation.Candidate')</a>
                            <ul class="sub-menu" aria-expanded="true">
                                <li><a href="#" key="t-list">@lang('translation.List')</a></li>
                                <li><a href="#" key="t-overview">@lang('translation.Overview')</a></li>
                            </ul>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="#" key="t-notifications">@lang('translation.Notifications')</a></li>
                         <li><a href="#"><span key="t-utilities">@lang('translation.Utilities')</span> <span class="badge rounded-pill bg-success float-end" key="t-new">@lang('translation.New')</span></a></li>
                    </ul>
                </li>
