<template>
    ...
    <form v-on:submit.prevent="sendSupport" method="post" class="needs-validation" novalidate>
        <div class="col-md-12">
            <div class="mb-3">
                <label for="for-point-subject" class="form-label">Subject</label>
                <input type="text" name="subject" class="form-control" id="for-point-subject" v-model="subject" readonly>
        ...
        <div class="col-lg-12">
            <div class="mb-3">
                <label for="point-request" class="form-label">Request</label>
                <select name="request" v-model="request" id="for-point-request" class="form-select">
        ...
        <div class="col-md-12">
            <div class="mb-3">
                ...
                <div>
                    <textarea id="point-description" name="description" v-model="description" class="form-control"
                        rows="3"></textarea>
                </div>
...
export default {
    ...
    data() {
        return {
            ...
            errors: new Errors(),
            subject: 'Point',
            requestSelect: ['REDEEM MY POINT', 'ASK A QUESTIONABOUT POINT'],
            request: 'REDEEM MY POINT',
            description: ''
        }
    },
    components: {},
