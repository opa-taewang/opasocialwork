...
@section('body')
                                ...
                                <div class="d-flex flex-column h-100">
                                    <div class="mb-4 mb-md-5">
                                        <a href="index" class="d-block auth-logo">
                                            <img src="{{ assetsets/images/logo-dark.png') }}" alt="" height="18"
                                                class="auth-logo-dark">
                                            <img src="{{ assetsets/images/logo-light.png') }}" alt="" height="18"
    ...
    @section('script')
        <!-- owl.carousel js -->
        <script src="{{ assetsets/libs/owl.carousel/owl.carousel.min.js') }}"></script>
        <!-- auth-2-carousel init -->
        <script src="{{ assetsets/js/pages/auth-2-carousel.init.js') }}"></script>
    @endsection